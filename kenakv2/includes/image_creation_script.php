...
//το αρχείο αυτό δεν περιλαμβάνεται στις σκιάσεις. Είναι καθαρά για test
...
ImageDashedLine($im, 10, $ymesotoixoy, $x2empod, $yempod, $black);
...
$tananoig = ((($platos_anoig / 2) + $apost_anoig_empod) / $mikos_empod);
