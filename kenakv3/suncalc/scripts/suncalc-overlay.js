...
$.extend(SuncalcOverlay.prototype, {
	...
	RED_PATH_ATTRS: 		["#FF0000", 0.4, 1],
	CYAN_PATH_ATTRS: 		["#00FFFF", 0.4, 1],
	...
	onAdd: function() {
		...
		//June 21
		this._jun21Curve = this._paper.path().attr(this._genPathAttrs(this.RED_PATH_ATTRS));
		
		//December 21
		this._dec21Curve = this._paper.path().attr(this._genPathAttrs(this.CYAN_PATH_ATTRS));
