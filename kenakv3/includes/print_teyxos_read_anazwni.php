...
$pin43 .= "Αδιαφανή δομικά στοιχεία<br/><br/>";
$pin43 .= "<table>";
$pin43 .= "<tr><td style=\"text-align:left;width:40%;\"><b>Όνομα αδιαφανούς</b></td>".
"<td style=\"text-align:center;width:20%;\"><b>U</b></td>".
"<td style=\"text-align:left;width:20%;\"><b>Umax [W/(m²K)] [Πίνακας 4.1]</b></td>".
"<td style=\"text-align:left;width:20%;\"><b>Απαίτηση</b></td></tr>";
...
$pin9 .= "<img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/PDF/user".$_SESSION['user_id']."-thermpchart".$z.$i.".png\" style=\"width:700px;height:230px; border:1px solid black; vertical-align:middle;\" ></img><br/>";
}
...
$pin10 .= "<img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/PDF/user".$_SESSION['user_id']."-coldpchart".$z.$i.".png\" style=\"width:700px;height:230px; border:1px solid black; vertical-align:middle;\" ></img><br/>";
}
...
"<td>${"pososto_petr_nov".$z}</td><td>${"pososto_petr_dec".$z}</td></tr></table><br/>";

$pin68 .= "<br/><img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/PDF/user".$_SESSION['user_id']."-znxchart".$z.".png\" style=\"width:700px;height:230px; border:1px solid black; vertical-align:middle;\" ></img><br/>";
}
}
//*********************************************************************************************
$pin69 = "";
...
$pinkoyf .= "<b>Ανατολικά Ανοίγματα</b><br><table><tr><td>Άνοιγμα</td><td>Τύπος</td><td>U [W/(m2K)]</td><td>Umax [W/(m2K)]</td><td>Απαίτηση</td></tr>";
...
$pinkoyf .= "<b>Νότια Ανοίγματα</b><br><table><tr><td>Άνοιγμα</td><td>Τύπος</td><td>U [W/(m2K)]</td><td>Umax [W/(m2K)]</td><td>Απαίτηση</td></tr>";
...
$pinkoyf .= "<b>Δυτικά Ανοίγματα</b><br><table><tr><td>Άνοιγμα</td><td>Τύπος</td><td>U [W/(m2K)]</td><td>Umax [W/(m2K)]</td><td>Απαίτηση</td></tr>";
...
$sygkrisiua1 = ${"uadiaa".$z}  / ${"umax".$z};
			if (${"sygkrisiua".$z}>1)${"elegxosua".$z}="<font color=\"red\">ΔΕΝ τηρείται U μικρότερο Umax.</font>";
			if (${"sygkrisiua".$z}<=1)${"elegxosua".$z}="<font color=\"green\">ΙΣΧΥΕΙ U μικρότερο Umax.</font>";
...
"</td></tr></table><br/><br/>";
$f13 .= "<table border=\"1\" cellpadding=\"2\" cellspacing=\"0\">".
...
$f13 .= "<img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/PDF/user".$_SESSION['user_id']."-znxchart".$z.".png\" style=\"width:700px;height:230px; border:1px solid black; vertical-align:middle;\" ></img><br/>";
}
}
//*********************************************************************************************
$f14 = "";
...
$t[3]="n";
$t[4]="d";
$strSQL = "SELECT * FROM kataskeyi_t_".$t[$tab]. " WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
...
$strSQL1 = "SELECT * FROM kataskeyi_an_".$t[$tab]." WHERE id_toixoy=".$objResult["id"]. " AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
...
//${"toixoi".$tab}.="<img src=\"http://localhost/kenakv3/includes/PDF/image".$tab.$im.".png\" style=\"width:".$gl ."px;height:".$gh ."px;\" ></img></td>";
${"toixoi".$tab}.="<br />Τοίχος <b>".$name."</b> ".number_format($tl,2,".",",")." x ".number_format($th,2,".",",")." &nbsp;";
${"toixoi".$tab}.="<img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/PDF/user".$_SESSION['user_id']."-image".$tab.$im.".png\" style=\"width:".$gl/2 ."px;height:".$gh/2 ."px; border:1px solid black; vertical-align:middle;\" ></img><br /><br />";
/*
$sgl+=$gl;
$ntd+=1;
...
$pinfwtismos .= "</table><br/>";
	...
	for ($i=1;$i<=${"systemlight_rows".$z};$i++){
		...
		<br/>";
		//$pinfwtismos .= "<img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/filemanager/userfiles/light_platos.png\" style=\"width:800px;height:463px; vertical-align:middle;\" ></img>";
		...
		<br/>";
		//$pinfwtismos .= "<img src=\"http://".$_SERVER['HTTP_HOST']."/kenakv3/includes/filemanager/userfiles/light_orofis.png\" style=\"width:600px;height:353px; border:1px solid black; vertical-align:middle;\" ></img>";
		}else{
		$pinfwtismos .= "<table>";
		$pinfwtismos .= "<tr><td>Ζώνη $z</td></tr>";
		$pinfwtismos .= "<tr><td>Τα φωτιστικά που θα χρησιμοποιηθούν για τους χώρους για χρήση ". ${"array_leitoyrgias".$z}[0][2].
...
//Δήλωση εαν δεν υπάρχει η γραμμή.
$strSQL = "SELECT * FROM teyxos_template WHERE kefalaio = ".$i. " AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
$num_rows = mysql_num_rows($objQuery);
if ($num_rows == 0){
$strSQL = "INSERT INTO teyxos_template ";
$strSQL .= "(user_id, meleti_id, kefalaio, text) ";
$strSQL .= "SELECT ".$_SESSION['user_id'].", ".$_SESSION['meleti_id'].", ".$i.", text FROM teyxos_template WHERE kefalaio = ".$i. " AND user_id=1 AND meleti_id=1;";
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
}
...
$objQuery1 = mysql_query("SELECT * FROM teyxos_template WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id']. " ORDER BY kefalaio") or die ("Error Query [".$strSQL."]");
while($objResult1[] = mysql_fetch_array($objQuery1));

for ($i=1;$i<=8;$i++){

//Δήλωση εαν δεν υπάρχει η γραμμή.
$strSQL = "SELECT * FROM teyxos_f WHERE kefalaio = ".$i. " AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
$num_rows = mysql_num_rows($objQuery);
if ($num_rows == 0){
$strSQL = "INSERT INTO teyxos_f ";
$strSQL .= "(user_id, meleti_id, kefalaio, text) ";
$strSQL .= "VALUES (".$_SESSION['user_id'].", ".$_SESSION['meleti_id'].", ".$i.", ' ');";
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
}

mysql_query("UPDATE teyxos_f SET text = ' ' WHERE kefalaio = ".$i. " AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id']); 
...
$c="";
mysql_query("UPDATE teyxos_f SET text = '".$teyxos."' WHERE kefalaio = ".$i." AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id']) or $c=$i; 
//echo $c;
//if ($c<>"")echo $teyxos;
