...
$j=$i+1;
$pdf->Output("PDF/user".$_SESSION['user_id']."-meleti".$_SESSION['meleti_id']."-printout".$j.".pdf", 'F');
...
?>
<script type="text/javascript">
window.open("PDF/user" + <?php echo $_SESSION['user_id']?> + "-meleti" + <?php echo $_SESSION['meleti_id']?> + "-printout<?=$j?>.pdf");
window.close();
</script>
