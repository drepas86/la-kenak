...
*/
	...
	if (isset($_POST['submit1'])) { // υποβλήθηκε η φόρμα.
		...
		$required_fields = array('name', 'platos_toixoy', 'apost_empod', 'platos_anoig', 'apost_anoig_empod', 'apost_yalo', 'mikos_empod', 'pros');
		$errors = array_merge($errors, check_required_fields($required_fields, $_POST));

		$fields_with_lengths = array('name' => 30, 'platos_toixoy' => 30, 'apost_empod' => 30, 'platos_anoig' => 30, 'apost_anoig_empod' => 30, 'apost_yalo' => 30, 'mikos_empod' => 30, 'pros' => 30);
		$errors = array_merge($errors, check_max_field_lengths($fields_with_lengths, $_POST));

		$name = trim(mysql_prep($_POST['name']));
		$platos_toixoy = trim(mysql_prep($_POST['platos_toixoy']));
		$apost_empod = trim(mysql_prep($_POST['apost_empod']));
		$platos_anoig = trim(mysql_prep($_POST['platos_anoig']));
		$apost_anoig_empod = trim(mysql_prep($_POST['apost_anoig_empod']));
		$apost_yalo = trim(mysql_prep($_POST['apost_yalo']));
		$mikos_empod = trim(mysql_prep($_POST['mikos_empod']));
		$thesi = trim(mysql_prep($_POST['thesi']));
		...
		if ( empty($errors) ) {
			...
			"?platost=" . $platos_toixoy . "&aposte=" . $apost_empod . "&platosa=" . 
			$platos_anoig . "&aposta=" . $apost_anoig_empod . "&mikose=" . $mikos_empod . "&name=" . $name . "&apost_yalo=" .$apost_yalo . "\"></img>";
			...
			*/
			...
			"<td>Απόσταση ανοίγματος από εμπόδιο</td><td>Απόσταση υαλοστασίων</td><td>Μήκος εμποδίου</td><td>Θέση εμποδίου</td><td>Προσανατολισμός</td></tr><tr><td>" . 
			$name . "</td><td>" . $platos_toixoy . "</td><td>" . $apost_empod . "</td><td>" . $platos_anoig . "</td><td>" . 
			$apost_anoig_empod . "</td><td>" . $apost_yalo . "</td><td>" . $mikos_empod . "</td><td>" . $thesi . "</td><td>" . $pros . "</td></tr></table><br/><br/>";
			...
			"<td>Προσανατολισμός επιφάνειας</td><td>f_fin_h Τοίχου</td><td>f_fin_c Τοίχου</td><td>f_fin_h Ανοίγματος</td><td>f_fin_c Ανοίγματος</td></tr><tr><td>" . 
			$name . "</td><td>" . $degtoixoy . " μοίρες</td><td>" . $deganoigmatos . " μοίρες</td><td>Πίνακας: " . $pinakasthesis . "</td><td>" . 
			$prosanatolismos_epif . "</td><td>" . $f_h . "</td><td>" . $f_c . "</td><td>" . $f_h_an . "</td><td>" . $f_c_an . "</td></tr></table>";
