...
*/
	...
	$sql = "UPDATE teyxos_f SET text = '$text' WHERE kefalaio = $kef AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
	if ($template=="1")$sql = "UPDATE teyxos_template SET text = '$text' WHERE kefalaio = $kef AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
