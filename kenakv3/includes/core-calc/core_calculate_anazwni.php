...
//-------------- ΣΤΟΙΧΕΙΑ ΑΝΕΞΑΡΤΗΤΑ ΤΗΣ ΘΕΡΜΙΚΗΣ ΖΩΝΗΣ ----------------------------
			$strSQL = "SELECT * FROM kataskeyi_stoixeia WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
...
//-------------- ΣΤΟΙΧΕΙΑ ΕΞΑΡΤΗΜΕΝΑ ΤΗΣ ΘΕΡΜΙΚΗΣ ΖΩΝΗΣ ------------------------------
			...
			//Δάπεδα
			$strSQL = "SELECT * FROM kataskeyi_dap WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			//Οροφές
			$strSQL = "SELECT * FROM kataskeyi_oro WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			//Χώροι κτιρίου
			$strSQL = "SELECT * FROM kataskeyi_xwroi WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			//εξωτερικές γωνίες
			$strSQL = "SELECT * FROM kataskeyi_therm_eks WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			//εσωτερικές γωνίες
			$strSQL = "SELECT * FROM kataskeyi_therm_es WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			//Άλλου τύπου
			$strSQL = "SELECT * FROM kataskeyi_therm_alles WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			$strSQL = "SELECT * FROM kataskeyi_ground WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			$strSQL = "SELECT * FROM kataskeyi_t_".$it[$p]." WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			$strSQL = "SELECT * FROM kataskeyi_an_".$it[$p]." WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			$strSQL = "SELECT * FROM kataskeyi_skiaseis_t_".$it[$p]." WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			...
			$strSQL = "SELECT * FROM kataskeyi_skiaseis_an_".$it[$p]." WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
		...
		${"epifaneia_dokos_".$t.$i} = (${"mikos_".$t.$i} - ${"ypostil_".$t.$i}) * ${"dokos_".$t.$i};
		${"epifaneia_ypost_".$t.$i} = ${"ypostil_".$t.$i} * ${"ypsos_".$t.$i};
		${"thermogefyres_toixoy_".$t.$i} = (${"mikos_".$t.$i} * ${"thermo_orofis_drop_".$t.$i}) + (${"mikos_".$t.$i} * ${"thermo_orofis_dap_".$t.$i}) + ((${"mikos_".$t.$i} - ${"ypostil_".$t.$i}) * ${"thermo_dokoy_drop_".$t.$i}) + (${"ypsos_".$t.$i} * ${"arithmos_ypost_".$t.$i} * ${"thermo_ypost_drop_".$t.$i} * 2);
		...
		${"epifaneia_ypost_".$t} += ${"epifaneia_ypost_".$t.$i};
			...
			${"pgen".$z} = ${"a_thermoperatotitas".$z} * ${"uadiaa".$z} * $pgen_dt * 2.5 /1000;
			}
			...
			*/
			...
			${"syntelestis_znx_iliakos_text".$z} =  " " . ${"mesi_katanalwsi_znx".$z} . " (ζώνη " . $z . ")";
			...
			$strSQL = "SELECT * FROM kataskeyi_xsystems_znxiliakos WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
			$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
			//$num_rows = mysql_num_rows($objQuery);
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_thermp WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_coldp WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_znxp WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_thermd WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_coldd WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_znxd WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_thermt WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_coldt WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_znxa WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_thermb WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_coldb WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
//Φωτισμός
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_light WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
//KKM
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_kkm WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_ygrp WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_ygrd WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
for ($z=1;$z<=$arithmos_thermzwnes;$z++){
$strSQL = "SELECT * FROM kataskeyi_xsystems_ygrt WHERE id_zwnis=$id_thermzwnes[$z] AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
//Πλαίσιο
$temp = mysql_query("SELECT * FROM kataskeyi_an_s WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id']);
...
//Στοιχεία μελέτης
$temp1 = mysql_query("SELECT * FROM kataskeyi_meletis WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id']);
...
$temp1 = mysql_query("SELECT * FROM kataskeyi_meletis_topo WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id']);
while($row1 = mysql_fetch_array($temp1)){
$sxedio=$row1['project'];
$odos=$row1['odos'];
...
$kataskeyi_stoixeia_array = get_times_all_user("*", "kataskeyi_stoixeia", $_SESSION['user_id'], $_SESSION['meleti_id']);
