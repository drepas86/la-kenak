...
$pdf->Output("includes/PDF/user".$_SESSION['user_id']."yd-n1599.pdf", 'F');

echo "Το pdf σώθηκε. Ανοίξτε το <a href=\"includes/PDF/user".$_SESSION['user_id']."yd-n1599.pdf\">εδώ.<a>";
?>
<script type="text/javascript">window.location = "includes/PDF/user" + <?php echo $_SESSION['user_id']?> + "yd-n1599.pdf"</script>
<?php
}
...
$pdf->Output("includes/PDF/user".$_SESSION['user_id']."yd-pfa.pdf", 'F');

echo "Το pdf σώθηκε. Ανοίξτε το <a href=\"includes/PDF/user".$_SESSION['user_id']."yd-pfa.pdf\">εδώ.<a>";
?>
<script type="text/javascript">window.location = "includes/PDF/user" + <?php echo $_SESSION['user_id']?> + "yd-pfa.pdf"</script>
<?php
}
...
$pdf->Output("includes/PDF/user".$_SESSION['user_id']."yd-symfwnia.pdf", 'F');

echo "Το pdf σώθηκε. Ανοίξτε το <a href=\"includes/PDF/user".$_SESSION['user_id']."yd-symfwnia.pdf\">εδώ.<a>";
?>
<script type="text/javascript">window.location = "includes/PDF/user" + <?php echo $_SESSION['user_id']?> + "yd-symfwnia.pdf"</script>
<?php
}
...
$pdf->Output("includes/PDF/user".$_SESSION['user_id']."yd-prokatabliteos.pdf", 'F');

echo "Το pdf σώθηκε. Ανοίξτε το <a href=\"includes/PDF/user".$_SESSION['user_id']."yd-prokatabliteos.pdf\">εδώ.<a>";
?>
<script type="text/javascript">window.location = "includes/PDF/user" + <?php echo $_SESSION['user_id']?> + "yd-prokatabliteos.pdf"</script>
<?php
}
?>