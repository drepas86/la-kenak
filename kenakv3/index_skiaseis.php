...
?>
			<?php if ($sel_page) { ?><h2><?php echo $sel_page['menu_name']; ?></h2>
				<div class="page-content">
					...
					<table border="1">
						<tr><td>α/α</td><td>Όνομα στοιχείου (Αλφαριθμητικό)</td><td>Πλάτος τοίχου (m)</td><td>Απόσταση τοίχου από εμπόδιο (m)</td><td>Πλάτος ανοίγματος (m)</td><td>Απόσταση ανοίγματος από εμπόδιο (m)</td><td>Απόσταση υαλοστασίων από εξωτερική παρειά (m)</td><td>Μήκος εμποδίου (m)</td><td>Θέση εμποδίου <br/>(1=αριστερά, 2=δεξιά)</td><td>Προσανατολισμός (μοίρες)</td></tr>
						<?php for ($i=1;$i<=10;$i++){ ?>
						<tr>
						<td><?=$i;?></td>
						<td><input type="text" name="name<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"name".$i}); ?>" /></td>
						<td><input type="text" name="platos_toixoy<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"platos_toixoy".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_empod<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_empod".$i}); ?>" /></td>
						<td width="30"><input type="text" name="platos_anoig<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"platos_anoig".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_anoig_empod<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_anoig_empod".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_yalo<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_yalo".$i}); ?>" /></td>
						<td><input type="text" name="mikos_empod<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"mikos_empod".$i}); ?>" /></td>
						<td><input type="text" name="thesi<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"thesi".$i}); ?>" /></td>
						<td><input type="text" name="pros<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"pros".$i}); ?>" /></td>
						</tr>
						<?php } ?>
						<tr>
					...
					<form action="index_skiaseis.php" method="post">
					<table border="1">
						<tr><td>α/α</td><td>Όνομα στοιχείου (Αλφαριθμητικό)</td><td>Ύψος τοίχου (m) a</td><td>Ύψος πόρτας (m) b</td><td>Ύψος παραθύρου (m) c</td><td>Ύψος ποδιάς (m) d</td><td>Απόσταση υαλοστασίων από εξωτερική παρειά (m) g</td><td>Απόσταση εμποδίου (m) e</td><td>Ύψος εμποδίου (m) f</td><td>Προσανατολισμός (μοίρες)</td></tr>
						<?php for ($i=1;$i<=10;$i++){ ?>
						<tr>
						<td><?=$i;?></td>
						<td><input type="text" name="name<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"name".$i}); ?>" /></td>
						<td><input type="text" name="ipsos_toixoy<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"ipsos_toixoy".$i}); ?>" /></td>
						<td><input type="text" name="ipsos_portas<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"ipsos_portas".$i}); ?>" /></td>
						<td><input type="text" name="ipsos_parath<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"ipsos_parath".$i}); ?>" /></td>
						<td><input type="text" name="ipsos_podias<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"ipsos_podias".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_yalo<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_yalo".$i}); ?>" /></td>
						<td><input type="text" name="apost_empod<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_empod".$i}); ?>" /></td>
						<td><input type="text" name="ypsos_empod<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"ypsos_empod".$i}); ?>" /></td>
						<td><input type="text" name="pros<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"pros".$i}); ?>" /></td>
						</tr>
						<?php } ?>
						<tr>
					...
					<form action="index_skiaseis.php" method="post">
					<table border="1">
						<tr><td>α/α</td><td>Όνομα στοιχείου (Αλφαριθμητικό)</td><td>Ύψος τοίχου (m) a</td><td>Ύψος πόρτας (m) b</td><td>Ύψος παραθύρου (m) c</td><td>Ύψος ποδιάς (m) d</td><td>Απόσταση υαλοστασίων από εξωτερική παρειά (m) g</td><td>Μήκος προβόλου (m) e</td><td>Προσανατολισμός (μοίρες)</td></tr>
						<?php for ($i=1;$i<=10;$i++){ ?>
						<tr>
						<td><?=$i;?></td>
						<td><input type="text" name="name<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"name".$i}); ?>" /></td>
						...
						<td><input type="text" name="ipsos_podias<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"ipsos_podias".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_yalo<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_yalo".$i}); ?>" /></td>
						<td><input type="text" name="mikos_prov<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"mikos_prov".$i}); ?>" /></td>
						<td><input type="text" name="pros<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"pros".$i}); ?>" /></td>
						</tr>
						<?php } ?>
						<tr>
					...
					<form action="index_skiaseis.php" method="post">
					<table border="1">
						<tr><td>α/α</td><td>Όνομα στοιχείου (Αλφαριθμητικό)</td><td>Πλάτος τοίχου ή ανοίγματος (m)</td><td>Απόσταση από εμπόδιο αριστερά (m)</td><td>Μήκος εμποδίου αριστερά (m)</td><td>Απόσταση από εμπόδιο δεξιά (m)</td><td>Μήκος εμποδίου δεξιά (m)</td><td>Προσανατολισμός (μοίρες)</td></tr>
						<?php for ($i=1;$i<=10;$i++){ ?>
						<tr>
						<td><?=$i;?></td>
						<td><input type="text" name="name<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"name".$i}); ?>" /></td>
						<td><input type="text" name="platos_toixoy<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"platos_toixoy".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_ar<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_ar".$i}); ?>" /></td>
						<td width="30"><input type="text" name="mikos_ar<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"mikos_ar".$i}); ?>" /></td>
						<td width="30"><input type="text" name="apost_de<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"apost_de".$i}); ?>" /></td>
						<td width="30"><input type="text" name="mikos_de<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"mikos_de".$i}); ?>" /></td>
						<td><input type="text" name="pros<?=$i;?>" maxlength="30" size="10" value="<?php echo htmlentities(${"pros".$i}); ?>" /></td>
						</tr>
						<?php } ?>
						<tr>
