...
*/
	...
	if (isset($_POST['submit3'])) { // υποβλήθηκε η φόρμα.
		...
		$required_fields = array('name', 'ipsos_toixoy', 'ipsos_portas', 'ipsos_parath', 'ipsos_podias', 'apost_yalo', 'mikos_prov', 'pros');
		$errors = array_merge($errors, check_required_fields($required_fields, $_POST));

		$fields_with_lengths = array('name' => 30, 'ipsos_toixoy' => 30, 'ipsos_portas' => 30, 'ipsos_parath' => 30, 'ipsos_podias' => 30, 'apost_yalo' => 30, 'mikos_prov' => 30, 'pros' => 30);
		...
		$mikos_prov = trim(mysql_prep($_POST['mikos_prov']));
		$pros = trim(mysql_prep($_POST['pros']));
		
		if ( empty($errors) ) {
			//Προβολή της εικόνας από τα δεδομένα του χρήστη (χρήση img tag με τη σελίδα δημιουργίας)
			echo "<img src=\"includes/image_creation_provolou.php" . "?ipsos_toixoy=" . $ipsos_toixoy . "&ipsos_portas=" . $ipsos_portas . "&ipsos_parath=" . 
			$ipsos_parath . "&ipsos_podias=" . $ipsos_podias . "&mikos_prov=" . $mikos_prov . "&pros=" . $pros . "&name=" . $name . "&apost_yalo=" . $apost_yalo . "\"></img>";
			
			
			echo "<img src=\"images/provolos.jpg\"></img><br/>";
			...
			"<td>Ύψος ποδιάς</td><td>Απόσταση υαλοστασίων</td><td>Mήκος προβόλου</td><td>Προσανατολισμός</td></tr><tr><td>" . 
			$name . "</td><td>" . $ipsos_toixoy . "</td><td>" . $ipsos_portas . "</td><td>" . $ipsos_parath . "</td><td>" . 
			$ipsos_podias . "</td><td>" . $apost_yalo . "</td><td>" . $mikos_prov . "</td><td>" . $pros . "</td></tr></table><br/><br/>";
