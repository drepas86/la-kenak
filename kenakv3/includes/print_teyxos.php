...
for ($i=1;$i<=8;$i++){
$f[$i]="PDF/user".$_SESSION['user_id']."-meleti".$_SESSION['meleti_id']."-printout".$i.".pdf";
}
$pdf =& new concat_pdf();
...
$pdf->Output("PDF/user".$_SESSION['user_id']."-meleti".$_SESSION['meleti_id']."-teyxos.pdf", 'F');
?><script type="text/javascript">window.location = "PDF/user" + <?php echo $_SESSION['user_id']?> + "-meleti" + <?php echo $_SESSION['meleti_id'];?> + "-teyxos.pdf"</script><?php
