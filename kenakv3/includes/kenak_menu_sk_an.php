...
?>
					...
					<?php
					$strSQL = "SELECT * FROM kataskeyi_skiaseis_an_".$it[$j]. " WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
					...
					{
					$i++;
					$name_an_array = get_times_user("name", "kataskeyi_an_".$it[$j], $objResult["id_an"], $_SESSION['user_id'], $_SESSION['meleti_id']);
					$name_an = $name_an_array[0]["name"];
					?>
...
<!--					<td><div align="center"><?=$objResult["id"];?></div></td> -->
					...
					$vasi = "prosthiki";
						...
						<?php
						echo "<tr>";
						$id_an = dropdown1("SELECT id, name FROM kataskeyi_an_".$it[$j]. " WHERE user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'], "id", "name");		
