...
<table width=100% id="maintable"><tr><td style="width:50%;vertical-align:middle;"><h2>ΚΕΝΑΚ - Συστήματα</h2></td>
<td style="vertical-align:middle;">
<img src="./images/domika/help.png"  width="40px" height="40px"  title="Γενική βοήθεια" style="cursor:pointer;" onclick=help_t(); />
</td>
</td></tr></table>
...
function help_t(){
$.colorbox({inline:true,  href:"#guide", width:"80%", height:"80%"});
}	
...
<div style='display:none'>
	...
	<br/><br/>
	<b>Ηλεκτρικές μονάδες (ηλεκτρικά σώματα άμεσης απόδοσης:θερμοπομποί, μονάδες επαγωγής, ηλεκτρικοί θερμοσυσσωρευτές)</b><br/>
	...
	<b>Τοπικές μονάδες αερίων ή υγρών καυσίμων (θερμάστρες υγραερίου, φυσικού αερίου, πετρελαίου κλπ)</b><br/>
	Θερμική ισχύς: Ίση με την αναγραφόμενη σε KW<br/>
	Βαθμός απόδοσης: Η αναγραφόμενη ή για συστήματα χωρίς καπνοδόχο=1 και με καπνοδόχο=0,7<br/><br/>
	
	<b>Ανοιχτές εστίες καύσης (Σόμπες, τζάκια)</b><br/>
	Βαθμός απόδοσης: <br/>
...
<!--        Κρυφό div για γενική βοήθεια                                            -->
		...
		<b>Συστήματα</b><hr>
		Στη σελίδα αυτή γίνεται η εισαγωγή των συστημάτων (Η/Μ) του κτιρίου.
		...
		Γίνεται αντιστοίχηση των συστημάτων που προσθέτετε με βάση τις θερμικές ζώνες που έχουν προστεθεί. Για κάθε θερμική ζώνη (στην οποία έχει δηλωθεί να πραγματοποιηθεί 
		έλεγχος θερμομονωτικής επάρκειας) πρέπει με βάση τις απαιτήσεις του λογισμικού ΤΕΕ-ΚΕΝΑΚ να προστεθεί τουλάχιστον ένα σύστημα ΘΕΡΜΑΝΣΗΣ, ΨΥΞΗΣ και ΖΝΧ. Εαν προστεθούν συστήματα σε
		ζώνη στην οποία έχει δηλωθεί να μην πραγματοποιηθεί έλεγχος θερμομονωτικής επάρκειας αυτά δεν λαμβάνονται υπ' όψη και δεν περνούν στο xml. <br /><br />
		<hr>
		Τα παραπάνω στοιχεία περνούν αυτόματα κατά την δημιουργία του xml στο λογισμικό του ΤΕΕ στη ζώνη που έχουν οριστεί.<br /><br />
		Σε τριτογενή τομέα απαιτείται να δηλώσετε τουλάχιστον ένα σύστημα ΦΩΤΙΣΜΟΣ και ΜΗΧΑΝΙΚΟΣ ΑΕΡΙΣΜΟΣ, ΥΓΡΑΝΣΗΣ εαν υπάρχει απαίτηση με βάση τον πίνακα της βιβλιοθήκης χρήσεων.<br /><br />
		<font color="green">Εαν δεν υπάρχουν δεδομένα ΦΩΤΙΣΜΟΣ, ΜΗΧΑΝΙΚΟΣ ΑΕΡΙΣΜΟΣ, ΥΓΡΑΝΣΗ ή ΗΛΙΑΚΟΣ δεν εισάγονται και δεν εμφανίζονται στο ΤΕΕ-ΚΕΝΑΚ. <br/>
		...
		Στο τεύχος ο ηλιακός εμφανίζεται πάντα ακόμα και αν δεν γίνει εισαγωγή κάποιου τύπου (απαίτηση κάλυψης αναγκών ΖΝΧ).</font>	<br/>	
		<hr>
		
		<b>Θεωρητικά συστήματα (αναφοράς)</b><br/>
		Στην περίπτωση μη ύπαρξης κάποιου συστήματος εισάγεται ένα θεωρητικό σύστημα (αναφοράς) το οποίο έχει τις εξής προδιαγραφές με βάση την 2η έκδοση της ΤΟΤΕΕ-20701-1:<br/><br/>
		
		<font color="red">Θέρμανση</font><br/>
		<table border="1">
		<tr><td>Είδος</td><td>Προδιαγραφές</td></tr>
		<tr><td>Μονάδα παραγωγής<br/>(παρ. 4.1.1δ)</td>
		<td>
		Τύπος:Λέβητας<br/>
        Πηγή ενέργειας: Πετρέλαιο<br/>
        Ισχύς: 0 kW<br/>
        Β.Απ.: 0,935<br/>
        COP:1<br/>
        Συντελεστές: <br/>
		...
		<font color="cyan">ΖΝΧ</font><br/>
		<table border="1">
		<tr><td>Είδος</td><td>Προδιαγραφές</td></tr>
		<tr><td>Μονάδα παραγωγής<br/>(παρ. 4.8.1.1)</td>
		<td>
		Τύπος: Λέβητας (Τοπικός ηλεκτρικός θερμαντήρας αν κατανάλωση ΖΝΧ μικρότερη από 10lit/άτομο/ημέρα)<br/>
        Πηγή ενέργειας: Πετρέλαιο (Ηλεκτρισμός αν κατανάλωση ΖΝΧ μικρότερη από 10lit/άτομο/ημέρα)<br/>
        Ισχύς: 0 kW<br/>
        Β.Απ.: 0.935 (1 αν κατανάλωση ΖΝΧ μικρότερη από 10lit/άτομο/ημέρα)<br/>
        ...
        Χώρος διέλευσης: "Εσωτερικοί ή έως και 20% σε εξωτερικούς"<br/>
        Β.Απ.: Πίνακας 4.16 της ΤΟΤΕΕ 20701-1 (1 αν κατανάλωση ΖΝΧ μικρότερη από 10lit/άτομο/ημέρα)<br/>
		</td></tr>
		<tr><td>Τερματικές μονάδες<br/>(παρ. 4.8.4)</td>
		<td>
		Τύπος: κενό<br/>
        Β.Απ.: 0,93 (0,98 αν κατανάλωση ΖΝΧ μικρότερη από 10lit/άτομο/ημέρα)<br/>
		</td></tr>
        ...
        Ισχύς: <br/>
		Κατοικίες: 0ΚW<br/>
		Τριτογενής τομέας: εμβαδόν θερμικής ζώνης x  0,1 W/m<sup>2</sup> (0 αν κατανάλωση ΖΝΧ μικρότερη από 10lit/άτομο/ημέρα)<br/>
		<font color="red">Οι τιμές εισάγονται σε KW</font>
		</td></tr>
		</table><br/><br/>
		
		<font color="red">Φωτισμός (παρ. 5.1.3.1)</font><br/>
		<table border="1">
		<tr><td>Εγκατεστημένη Ισχύς:</td><td>εμβαδόν θερμικής ζώνης x ισχύς φωτισμού κτιρίου αναφοράς από Πίνακα 2.4.</td></tr>
		...
		<font color="green">Μηχανικός αερισμός (παρ. 4.6γ)</font><br/>
		<table border="1">
		<tr><td>Τύπος:</td><td>κενό</td></tr>
        <tr><td>Τμήμα Θέρμανσης:</td><td>Χωρίς τμήμα θέρμανσης</td></tr>
        <tr><td>F_h:</td><td>εμβαδόν θερμικής ζώνης x απαιτούμενο νωπό αέρα από Πίνακα 2.3</td></tr>
        <tr><td>R_h:</td><td>κενό</td></tr>
		<tr><td>Q_r_h:</td><td>κενό</td></tr>
        <tr><td>Τμήμα Ψυξης:</td><td>Χωρίς τμήμα ψύξης</td></tr>
        <tr><td>F_c:</td><td>εμβαδόν θερμικής ζώνης x απαιτούμενο νωπό αέρα από Πίνακα 2.3</td></tr>
        <tr><td>R_c:</td><td>κενό</td></tr>
        <tr><td>Q_r_c:</td><td>κενό</td></tr>
        <tr><td>Τμήμα Ύγρανσης:</td><td>Χωρίς τμήμα Ύγρανσης</td></tr>
        <tr><td>H_r:</td><td>κενό</td></tr>
        <tr><td>Φίλτρα:</td><td>Χωρίς φίλτρα</td></tr>
        <tr><td>E_vent:</td><td>1</td></tr>
		</table><br/><br/>
