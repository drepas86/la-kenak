...
$strSQL = "SELECT * FROM kataskeyi_skiaseis_an_a WHERE id_an = ".${$an."id".$i} . " AND user_id=".$_SESSION['user_id']." AND meleti_id=".$_SESSION['meleti_id'];
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
$num_results = mysql_num_rows($objQuery);
$objResult = mysql_fetch_array($objQuery);
if ($num_results > 0){ 
...
$objWriter->save("user".$_SESSION['user_id']."-excel-domika_anazwni.xlsx", __FILE__);
...
echo "<br/>" . "<a href=\"user".$_SESSION['user_id']."-excel-domika_anazwni.xlsx\" >Κατεβάστε το αρχείο XLSX</a>";
